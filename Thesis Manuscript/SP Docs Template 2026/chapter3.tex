...
This chapter establishes the theoretical foundations underlying the development of a machine learning-based diabetes risk prediction system with explainable artificial intelligence. The framework is organized into five key areas: diabetes and prediabetes fundamentals, machine learning and binary classification, neural networks and optimization strategies, explainable artificial intelligence and model interpretability, and model performance evaluation metrics.
